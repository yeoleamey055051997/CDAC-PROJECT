					...
					<tbody>
						<c:forEach var="listall" items="${listall}">
							<tr>
								...
								<td><c:out value="${listall.capacity}" /></td>
			...
			<div class="modal-content">
				<form action="insert" method="post">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Floar</label> <input type="text" name="floar"
						...
						<div class="form-group">
							<label>Vehicle type</label> <input type="text"
								name="vehicle_type"
								value="<c:out value="${exis.vehicle_type}"/>"
								class="form-control" placeholder="vehicle_type">
						</div>
						<div class="form-group">
							<label>Capacity</label> <input type="text" name="capacity"
								value="<c:out value="${exis.capacity}"/>" class="form-control"
			...
			<div class="modal-content">
				<form action="delete" method="post">
					...
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal"
							value="Cancel"> <input type="submit"
							class="btn btn-danger" value="delete" name="por">
					</div>
				</form>
			</div>
		</div>
